...
export function PasswordResetForm({ onBack }: { onBack: () => void }) {
  ...
  return (
    <motion.div 
      className="w-full max-w-md space-y-6 lg:space-y-8 px-4 sm:px-0"
    ...
    >
      ...
      <div className="text-center space-y-2 lg:space-y-3">
        <motion.div
          ...
          className="w-12 h-12 lg:w-16 lg:h-16 mx-auto rounded-full bg-gradient-to-br from-slate-600 to-gray-700 flex items-center justify-center shadow-lg"
        >
          {step === "forgot" ? (
        ...
        <p className="text-white/60 text-base lg:text-lg font-body px-2">
          {step === "forgot" 
          ...
          <div className="space-y-4 lg:space-y-5">
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="000000"
                maxLength={6}
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 backdrop-blur-sm border border-white/20 rounded-full text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500/50 transition-all duration-200 hover:bg-white/10 text-center text-lg sm:text-xl tracking-wider font-mono"
                required
              />
            </div>
      ...
      <div className="text-center">
        <button
          type="button"
          onClick={onBack}
          className="inline-flex items-center text-xs sm:text-sm text-white/60 hover:text-white/90 transition-colors duration-200 hover:underline underline-offset-4 font-body"
        >
