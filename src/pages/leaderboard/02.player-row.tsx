        ...
        <CardContent className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 gap-3 sm:gap-4">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            <div className="flex items-center gap-2 min-w-[50px] sm:min-w-[60px] flex-shrink-0">
              ...
              <span className="font-bold text-base sm:text-lg text-white/90">#{player.position}</span>
            </div>
            ...
            <div className="min-w-0 flex-1">
              <h4 className="font-semibold text-base sm:text-lg text-white/90 truncate">{player.username}</h4>
              <Badge variant="outline" className="flex items-center gap-1 w-fit bg-blue-500/20 text-blue-300 border-blue-500/30 mt-1">
          ...
          <div className="grid grid-cols-4 gap-3 sm:gap-6 text-center flex-shrink-0">
            <div>
              <div className="text-base sm:text-lg font-bold text-green-400">{player.wins}</div>
              <div className="text-xs text-white/60">Wins</div>
            </div>
            <div>
              <div className="text-base sm:text-lg font-bold text-red-400">{player.losses}</div>
              <div className="text-xs text-white/60">Losses</div>
            </div>
            <div>
              <div className="text-base sm:text-lg font-bold text-white/90">{player.gamesPlayed}</div>
