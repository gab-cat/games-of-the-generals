...
export function GameResultModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl w-full bg-zinc-950 backdrop-blur-xl border border-white/10 p-0 overflow-hidden shadow-2xl [&>button]:hidden text-white rounded-sm">
        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="w-full flex items-center justify-between px-6 py-3 border-b border-white/10 bg-black/40">
            ...
            <div className="text-xs font-mono text-white/20">{gameId}</div>
          </div>

          <div className="w-full p-8 md:p-12 flex flex-col items-center relative overflow-hidden">
            {/* Background Effects */}
            ...
            <motion.div
              ...
              className={`w-24 h-24 mb-6 rounded-2xl border-2 flex items-center justify-center relative ${
                isWinner
            ...
            >
              <h1
                className={`text-5xl md:text-7xl font-black tracking-tighter mb-2 ${getResultColor()}`}
              >
                {getResultText()}
              </h1>
              <div className="flex items-center justify-center gap-3">
                <div
                  className={`h-[1px] w-12 ${isWinner ? "bg-emerald-500" : "bg-red-500"}`}
                />
                <p className="text-sm font-mono tracking-[0.2em] text-white/60 uppercase">
                  {getMissionStatus()}
                </p>
                <div
                  className={`h-[1px] w-12 ${isWinner ? "bg-emerald-500" : "bg-red-500"}`}
            ...
            <motion.div
              ...
              className="w-full grid grid-cols-1 md:grid-cols-3 gap-px bg-white/5 border border-white/10 rounded-sm overflow-hidden mb-8"
            >
              <div className="bg-black/40 p-4 flex flex-col items-center justify-center text-center group hover:bg-zinc-800/40 transition-colors">
                <Clock className="w-5 h-5 text-blue-400 mb-2 opacity-70 group-hover:scale-110 transition-transform" />
              ...
              <div className="bg-black/40 p-4 flex flex-col items-center justify-center text-center group hover:bg-zinc-800/40 transition-colors">
                <Zap className="w-5 h-5 text-amber-400 mb-2 opacity-70 group-hover:scale-110 transition-transform" />
                <div className="text-2xl font-mono font-bold text-white">
                  {result.moves}
                </div>
                <div className="text-[10px] uppercase tracking-widest text-white/40">
              ...
              <div className="bg-black/40 p-4 flex flex-col items-center justify-center text-center group hover:bg-zinc-800/40 transition-colors">
                <Medal className="w-5 h-5 text-purple-400 mb-2 opacity-70 group-hover:scale-110 transition-transform" />
            ...
            <motion.div
              ...
              className="w-full flex items-center justify-between gap-4 mb-8 px-4"
            >
              {/* You */}
              <div className="flex items-center gap-3">
                <UserAvatar
                  ...
                  className={`w-10 h-10 border-2 ${isWinner ? "border-emerald-500" : "border-red-500"}`}
                />
                <div className="flex flex-col">
                  <span className="text-xs font-bold text-white">YOU</span>
                  <span
                    className={`text-[10px] font-mono ${isWinner ? "text-emerald-400" : "text-red-400"}`}
                  >
            ...
            >
              <Button
                ...
                variant="outline"
                className="h-12 border-white/10 hover:bg-white/5 text-white bg-transparent font-mono text-xs tracking-wider rounded-sm"
              >
              ...
              {gameId && onViewReplay && (
                <Button
                  ...
                  variant="outline"
                  className="h-12 border-blue-500/30 text-blue-400 hover:bg-blue-500/10 bg-blue-500/5 font-mono text-xs tracking-wider rounded-sm"
                >
              ...
              <Button
                ...
                className="h-12 bg-white text-black hover:bg-white/90 font-bold font-mono text-xs tracking-wider rounded-sm"
              >
